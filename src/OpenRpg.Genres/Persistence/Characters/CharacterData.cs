...
namespace OpenRpg.Genres.Persistence.Characters
{
    public class CharacterData
    {
        ...
        public CharacterData(Guid id, string nameLocaleId, string descriptionLocaleId, byte genderType, IReadOnlyDictionary<int, float> stateVariables, IReadOnlyDictionary<int, object> variables = null)
        {
            Id = id;
