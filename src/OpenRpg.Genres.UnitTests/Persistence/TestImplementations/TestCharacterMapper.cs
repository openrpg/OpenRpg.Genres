...
namespace OpenRpg.Genres.UnitTests.Persistence.TestImplementations
{
    public class TestCharacterMapper : CharacterMapper
    {
        ...
        public TestCharacterMapper(IItemMapper itemMapper, IClassMapper classMapper, IEquipmentMapper equipmentMapper, IInventoryMapper inventoryMapper, IStatPopulator statsPopulator) : base(itemMapper, classMapper, equipmentMapper, inventoryMapper, statsPopulator)
        {
        }
